...
export const ONLINE_REPORT_TEMPLATES: AnalyticTemplateData[] = [
  {
    ...
    query: `SHOW pre_orders, return_count, pre_net_sales BY assignee_code,assignee_name FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy') 
  ...
  },
  {
    ...
    query: `SHOW pre_orders, return_count, pre_net_sales BY marketer_code,marketer_name FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC `,
  ...
  },
  {
    ...
    query: `SHOW pre_net_sales BY coordinator_name,coordinator_code,order_sub_status FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy') 
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC `,
  ...
  },
  {
    type: "Báo cáo đơn hàng",
    name: "theo kênh bán",
    query: `SHOW pre_orders, return_count, pre_net_sales, net_sales BY channel_provider_name,source_name FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
  ...
  },
  {
    type: "Báo cáo đơn hàng",
    name: "theo đơn tạo",
    query: `SHOW pre_orders, return_count, pre_net_sales, net_sales OVER day FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC`,
  ...
  },
  {
    ...
    query: `SHOW orders, return_count, net_sales, net_quantity, average_order_value, customers 
        OVER day 
        FROM sales 
  ...
  },
  {
    type: "Báo cáo đơn hàng",
    name: "theo shop",
    query: `SHOW pre_orders, return_count, pre_net_sales, net_sales BY source_department_lv2,source_department_name FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC `,
  ...
  },
  {
    ...
    query: `SHOW pre_orders, pre_net_sales BY order_sub_status FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC`,
  ...
  },
  {
    ...
    query: `SHOW pre_orders, return_count, net_quantity, pre_net_sales, net_sales BY shipping_city FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC `,
...

  {
    ...
    query: `SHOW pre_ordered_item_quantity, ordered_item_quantity, returned_item_quantity, pre_net_sales, net_sales BY variant_sku3 FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC `,
  ...
  },
  {
    ...
    query: `SHOW pre_ordered_item_quantity, ordered_item_quantity, returned_item_quantity, pre_net_sales, net_sales BY variant_sku7 FROM sales WHERE sale_area IN ('Khối KD Online') AND cancelled IN ('Chưa hủy')  
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY pre_net_sales DESC `,
  ...
  },
  {
    ...
    query: `SHOW orders, return_count, ordered_item_quantity, returned_item_quantity, net_sales BY customer_name,customer_phone_number FROM sales WHERE sale_area IN ('Khối KD Online') 
        SINCE ${START_OF_MONTH} UNTIL ${TODAY} 
        ORDER BY net_sales DESC `,
    cube: AnalyticCube.Sales,
    alias: [UrlConfig.ANALYTIC_SALES_ONLINE],
