...
const VariantExportMapping = {
  [VariantExportField.product_code]: "Mã cha",
  [VariantExportField.product_name]: "Tên cha",
  ...
  [VariantExportField.images]: 'Link ảnh',
  ...
  [VariantExportField.on_hold]: 'Tạm giữ',
  [VariantExportField.defect]: 'Hàng lỗi',
  [VariantExportField.in_coming]: 'Chờ nhập',
  [VariantExportField.on_way]: 'Chuyển đến',
  [VariantExportField.transferring]: 'Chuyển đi',
  [VariantExportField.shipping]: 'Đang giao',
