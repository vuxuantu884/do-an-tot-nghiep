...
): Promise<BaseResponse<Array<CollectionResponse>>> => {
...
export const collectionDeleteProductApi = (
  id: number,
  productId: number,
...
export const collectionUpdateProductsApi = (
  request: CollectionUpdateRequest,
): Promise<BaseResponse<string>> => {
  return BaseAxios.put(`${ApiConfig.PRODUCT}/products/collections`, request);
};

export const getProductsCollectionApi = (
