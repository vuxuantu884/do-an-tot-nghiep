...
export const createPurchaseOrder = (data: PurchaseOrder): Promise<BaseResponse<PurchaseOrder>> => {
...
export const updateNotePurchaseOrder = (
  ...
  return BaseAxios.put(`${ApiConfig.PURCHASE_ORDER}/purchase-orders/${id}/notes`, data);
};

export const updatePurchaseOrderFinancialStatus = (
  id: number,
): Promise<BaseResponse<PurchaseOrder>> => {
  return BaseAxios.put(`${ApiConfig.PURCHASE_ORDER}/purchase-orders/${id}/financial-status/finish`);
};

export const deletePurchaseOrder = (ids: string): Promise<BaseResponse<string>> => {
...
export const returnPurchaseOrder = (
  ...
  return BaseAxios.post(`${ApiConfig.PURCHASE_ORDER}/purchase-orders/${id}/return`, data);
};
...
export const searchPurchaseOrderApi = (
  ...
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/purchase-orders?${queryString}`);
};

export const getPurchaseOrderApi = (id: string): Promise<BaseResponse<PurchaseOrder>> => {
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/purchase-orders/${id}`);
};

export const cancelPurchaseOrderApi = (id: string): Promise<BaseResponse<PurchaseOrder>> => {
...
export const exportPOApi = (
  ...
  return BaseAxios.post(`${ApiConfig.PURCHASE_ORDER}/excel/job/export`, data);
};

export const createPurchaseOrderConfigService = (
  request: FilterConfigRequest,
): Promise<BaseResponse<FilterConfig>> => {
  return BaseAxios.post(`${ApiConfig.PURCHASE_ORDER}/config`, request);
};
...
export const getPurchaseOrderConfigService = (
  ...
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/config/${code}`);
};

export const deletePurchaseOrderConfigService = (
  id: number,
): Promise<BaseResponse<Array<FilterConfig>>> => {
  return BaseAxios.delete(`${ApiConfig.PURCHASE_ORDER}/config/${id}`);
};
...
export const getProcumentLogsService = (
  ...
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/procurements/logs?${params}`);
};

export const listPurchaseOrderApi = (
  query: PurchaseOrderQuery,
): Promise<BaseResponse<PageResponse<PurchaseOrderQuery>>> => {
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/purchase-orders/list?ids=${query.ids}`);
};

export const listPurchaseOrderBySupplier = (
  id: number,
  query?: PurchaseOrderBySupplierQuery,
): Promise<BaseResponse<Array<PurchaseOrder>>> => {
...
export const printMultipleProcurementApi = (ids: string): Promise<Array<PurchaseOrderPrint>> => {
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/purchase-orders/print-procurement?ids=${ids}`);
};

export const printVariantBarcodeByPOApi = (
  params: POStampPrinting,
): Promise<BaseResponse<string>> => {
...
export const updatePurchaseOrderStatusWaitingApproval = (
  ...
  return BaseAxios.put(
    `${ApiConfig.PURCHASE_ORDER}/purchase-orders/update-status/waiting-approval?ids=${ids}`,
  );
};

export const getPurchaseOrderReturnList = (
  query?: PurchaseOrderReturnQuery,
