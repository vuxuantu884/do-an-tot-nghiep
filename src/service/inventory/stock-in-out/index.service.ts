...
import { StockInOutOther, StockInOutOtherData, StockInOutOtherPrint } from "model/stock-in-out-other";


const createStockInOutOthers = (
...
const updateStockInOutOthers = (id: number, data: StockInOutOtherData): Promise<BaseResponse<string>> => {
...
const printStockInOutOtherDetail = (id: number): Promise<BaseResponse<StockInOutOtherPrint>> => {
  return BaseAxios.get(`${ApiConfig.PURCHASE_ORDER}/stock-in-out-others/print-stock-in-out-other?id=${id}&print_type=stock_in_out_other`)
}
