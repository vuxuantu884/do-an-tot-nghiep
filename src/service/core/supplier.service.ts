...
export const supplierGetApi = (
  query?: SupplierQuery,
): Promise<BaseResponse<PageResponse<SupplierResponse>>> => {
...
export const supplierPutApi = (
  id: number,
  request: SupplierUpdateRequest,
): Promise<BaseResponse<SupplierResponse>> => {
  return BaseAxios.put(`${ApiConfig.CORE}/suppliers/${id}`, request);
};

export const supplierPostApi = (
  request: SupplierCreateRequest,
): Promise<BaseResponse<SupplierResponse>> => {
  return BaseAxios.post(`${ApiConfig.CORE}/suppliers`, request);
};

export const supplierCreateAddressApi = (
  id: number,
...
export const supplierUpdateAddressApi = (
  id: number,
  addressId: number,
  request: SupplierAddress,
): Promise<BaseResponse<SupplierResponse>> => {
...
export const supplierDeleteAddressApi = (
  id: number,
  addressId: number,
): Promise<BaseResponse<SupplierResponse>> => {
...
export const supplierCreateContactApi = (
  id: number,
...
export const supplierUpdateContactApi = (
  id: number,
  addressId: number,
  request: SupplierContact,
): Promise<BaseResponse<SupplierResponse>> => {
...
export const supplierDeleteContactApi = (
  id: number,
  addressId: number,
): Promise<BaseResponse<SupplierResponse>> => {
...
export const supplierCreatePaymentApi = (
  id: number,
...
export const supplierUpdatePaymentApi = (
  id: number,
  paymentId: number,
  request: SupplierPayment,
): Promise<BaseResponse<SupplierResponse>> => {
...
export const supplierDeletePaymentApi = (
  id: number,
  paymentId: number,
): Promise<BaseResponse<SupplierResponse>> => {
