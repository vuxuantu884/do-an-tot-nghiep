...
import { DuplicateOrderSearchQuery, OrderModel, OrderSearchQuery } from './../../model/order/order.model';
...
export const putOrderMergeService=(origin_id:number,ids:number[]):Promise<BaseResponse<OrderModel>>=>{
