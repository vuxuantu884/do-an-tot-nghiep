...
const WebAppConfig: React.FC = () => {
    ...
    switch (history.location.pathname) {
      ...
      default:
        if (history.location.pathname.includes(WebAppConfigTabUrl.CONFIG_SHOP))
          setActiveTab(WebAppConfigTabUrl.CONFIG_SHOP);
        else setActiveTab(WebAppConfigTabUrl.SHOP_LIST);
        break;
    }
  }, [history.location]);
  ...
  const handleDeleteShop = () => {
    ...
    if (modalShopInfo) dispatch(webAppConfigDeleteAction(modalShopInfo.id, deleteShopCallback));
  };
