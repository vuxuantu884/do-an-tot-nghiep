  ...
  return (
    <Modal
      ...
      footer={[
        ...
        <Button key="ok" type="primary" onClick={handleCreateShop} loading={loading}>
    ...
    >
      ...
      {statusCreate === "info_shop" && (
        <div>
          <Row gutter={5}>
            <Col span={10}>
              <span style={{ fontWeight: 500 }}>Tên gian hàng:</span>
            </Col>
            <Col span={14}>{infoShop.name}</Col>
          </Row>
          <Row gutter={5}>
            <Col span={10}>
              <span style={{ fontWeight: 500 }}>Website:</span>
            </Col>
            <Col span={14}>{infoShop.website}</Col>
          </Row>
        </div>
      )}
    </Modal>
