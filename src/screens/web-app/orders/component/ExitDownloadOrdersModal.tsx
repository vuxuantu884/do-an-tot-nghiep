...
const ExitDownloadOrdersModal: React.FC<ExitDownloadOrdersModalType> = (
  ...
  const { visible, pageTitle, onOk, onCancel } = props;
    ...
    >
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ marginLeft: 15 }}>
          ...
          <div style={{ fontSize: 14 }}>Hệ thống sẽ dừng việc tải đơn về, các đơn hàng đã tải thành công sẽ được hiển thị ở màn hình "{pageTitle}"</div>
        </div>
      </div>
    </Modal>
