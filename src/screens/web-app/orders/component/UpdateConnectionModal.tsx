...
import { StyledProductListDropdown, StyledYodyProductColumn } from "screens/web-app/products/tab/not-connected-items/styles";
import { StyledUpdateConnectionModal } from "screens/web-app/orders/orderStyles";
...
const UpdateConnectionModal: React.FC<UpdateConnectionModalType> = (
  ...
  const RenderProductColumn = (item: any) => {
    ...
    const saveConnectYodyProduct = (itemId: any) => {
      ...
      dispatch(
        putConnectWebAppProductAction(request, (result) => {
