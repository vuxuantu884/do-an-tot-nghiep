            ...
            <Row>
              ...
              <Col xs={20} md={20}>
                <div className="greeting__content">
                  <span className="name">
                    {timeOfDayVietnamese[timeOfDay]} {userName}!
                  </span>
                  <p className="quote">
                    “Luôn đặt sự hài lòng của khách hàng là ưu tiên số 1 trong mọi suy nghĩ và hành
                    động của mình. Luôn Chủ động, Cười, Chào, Cảm ơn.”
                  </p>
                </div>
              </Col>
            </Row>
