import {
  ...
  BUSINESS_RESULT_QUERY_TOTAL_SALES_COMPLETED,
  ReportDatavalue,
...
function useFetchBusinessResultComplete() {
  ...
  const [isFetchingBusinessResultComplete, setIsFetchingBusinessResultComplete] =
  ...
  useEffect(() => {
    const fetchTotalSaleComplete = async () => {
      ...
      setDataSrcBusinessResultCard((prevState: Map<string, BusinessResultCartItem>) => {
        ...
        newState.set(BUSINESS_RESULT_CART_NAME.online, {
          value: salesOnlineToday,
          monthlyAccumulated: accumulateSalesOnline,
        });
        newState.set(BUSINESS_RESULT_CART_NAME.offline, {
          value: salesOfflineToday,
          monthlyAccumulated: accumulateSalesOffline,
        });
        newState.set(BUSINESS_RESULT_CART_NAME.return, {
          value: returnToday,
          monthlyAccumulated: accumulateReturn,
        });
