...
const StockInOutExport: React.FC<ExportModalProps> = (props: ExportModalProps) => {
  const [form] = Form.useForm();
  const { visible, onCancel, onOk, exportProgress, statusExport = 0, isLoading } = props;
  ...
  return (
    <Modal
      ...
      cancelText="Hủy"
      onOk={onOkClick}
      title="Xuất file nhập xuất khác"
      okText="Xuất file"
    >
      <Form
        form={form}
...
export default StockInOutExport;
