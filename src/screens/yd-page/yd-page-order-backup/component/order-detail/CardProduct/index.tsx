...
// import AddGiftModal from "screens/yd-page/yd-page-order/modal/add-gift.modal";
// import InventoryModal from "screens/yd-page/yd-page-order/modal/inventory.modal";
// import PickDiscountModal from "screens/yd-page/yd-page-order/modal/pick-discount.modal";
import {
  findAvatar,
  findPrice,
  findPriceInVariant,
...
const CardProduct: React.FC<CardProductProps> = (props: CardProductProps) => {
  ...
  return (
    <Card
      className="yd-page-order padding-12"
      extra={
        <Space size={20}>
