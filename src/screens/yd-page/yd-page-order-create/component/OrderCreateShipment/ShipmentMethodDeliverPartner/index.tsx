  ...
  return (
    <StyledComponent>
      <div className="shipmentMethod__deliverPartner">
        {addressError && <div style={{ color: "#ff4d4f" }}>{addressError}</div>}
        {levelOrder > 3 && (
        ...
        <Row gutter={20}>
          <Col span={12} style={{ padding: "0 5px 0 10px" }}>
            <Form.Item className="form-input-deliver" label="Tiền thu hộ:">
              <NumberInput
            ...
            <div className="ant-table-content">
              <table className="table-bordered" style={{ width: "100%", tableLayout: "auto" }}>
                  ...
                  <tr>
                    ...
                    <th style={{ padding: 0 }}>
                      <div className="delivery-method-item">
                        <div className="method method-th" style={{ textAlign: "center" }}>
                          Dịch vụ chuyển phát
                        </div>
                        <div
                          className="cost method-th"
                          style={{ borderBottom: "unset", textAlign: "center" }}
                        >
                          Cước phí
                        </div>
                      </div>
                ...
                <tbody className="ant-table-tbody">
                  {serviceFees.map((serviceFee: any) => {
                    return (
