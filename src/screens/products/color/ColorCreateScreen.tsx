...
const initialRequest: ColorCreateRequest = {
  code: "",
  parent_id: null,
  name: "",
  hex_code: null,
...
const ColorCreateScreen: React.FC = () => {
  ...
  return (
    ...
    >
      <Form ref={formRef} onFinish={createColor} initialValues={initialRequest} layout="vertical">
        ...
        <BottomBarContainer
          ...
          rightComponent={
            <Button loading={isLoadingSaveButton} htmlType="submit" type="primary">
              Tạo màu sắc
            </Button>
          }
        />
