...
const TabHistoryInfo: React.FC = () => {
  ...
  const [columns, setColumns] = useState<
    Array<ICustomTableColumType<ProductHistoryResponse>>>(defaultColumn);
    
  const {tableColumnConfigs, onSaveConfigTableColumn} = useHandleFilterColumns(COLUMN_CONFIG_TYPE.COLUMN_PRODUCT_HISTORY);
  useSetTableColumns(COLUMN_CONFIG_TYPE.COLUMN_PRODUCT_HISTORY, tableColumnConfigs, defaultColumn, setColumns);
