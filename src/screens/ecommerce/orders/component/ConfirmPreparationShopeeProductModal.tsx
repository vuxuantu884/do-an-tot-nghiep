    ...
    >
      <div className="error-logs-body">
        <div className="error-summary">
          ...
          <span>
            Có <span className="text-success">{orderSuccessMessage.length}</span> đơn hàng{" "}
        ...
        <div className="error-summary">
          ...
          <span>
            Có <span className="text-error">{orderErrorMessage.length}</span> đơn hàng{" "}
          ...
          <div className="error-message">
            <ul className="error-message-list">
              {shopeePreparationData.length &&
                shopeePreparationData?.map((item, idx) => (
                  <React.Fragment>
                    {item.error !== "" && (
                      <li key={idx}>
