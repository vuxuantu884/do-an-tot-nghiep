  ...
  return (
    <PurchaseOrderStyleWrapper>
      <ContentContainer
        ...
        extra={
          (path === PurchaseOrderTabUrl.LIST && <Row>
            <Space>
              <Button
                hidden
                className="light"
      ...
      >
        <Card className="card-tab">
          ...
          >
            <TabPane tab={<Link to={PurchaseOrderTabUrl.LIST}>Danh sách đơn đặt hàng</Link>} key={PurchaseOrderTabUrl.LIST}>
              <PurchaseOrderListScreen showExportModal={showExportModal} setShowExportModal={setShowExportModal} setError={setError} />
            </TabPane>
            <TabPane tab={<Link to={PurchaseOrderTabUrl.RETURN}>Danh sách phiếu trả hàng</Link>} key={PurchaseOrderTabUrl.RETURN}>
