...
const ModalExport: React.FC<ModalImportProps> = (props: ModalImportProps) => {
  const { visible, onOk, onCancel, title, cancelText, templateUrl, forder, customParams } = props;
  ...
  const [exportRes, setExportRes] = useState<Array<any>>([]);
  ...
  return (
    ...
    >
      <div
        style={{
          display:
            uploadStatus === undefined || uploadStatus === EnumImportStatus.removed ? "" : "none",
        }}
      >
            ...
            <Col span={24}>
              {uploadStatus === EnumImportStatus.success && (
                <>
                  ...
                  <Row justify={"center"}>
                    <h2 style={{ padding: "10px 30px" }}>Xử lý file thành công</h2>
                  </Row>
                </>
              )}
              <Divider />
