...
import { getPriceRuleAction, updatePriceRuleByIdAction } from 'domain/actions/promotion/discount/discount.action'
...
function IssueUpdate(props: Props): ReactElement {
    ...
    const { setPriceRuleData, setIsLimitUsage, setIsLimitUsagePerCustomer } = useContext(IssueContext);
    ...
    const onFinish = (values: any) => {
        try {
            ...
            body.id = priceRuleId;
            dispatch(updatePriceRuleByIdAction(body, (result: PriceRule) => {
                if (result) {
