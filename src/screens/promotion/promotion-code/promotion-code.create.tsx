...
import GeneralInformation from "screens/fpage/fpage-customer/general.information";
import CustomInputContact from "screens/customer/common/customInputContact";
const { Panel } = Collapse;
const initQueryAccount: AccountSearchQuery = {
  info: "",
};
const PromotionCodeCreate = (props: any) => {
...
export default PromotionCodeCreate;
