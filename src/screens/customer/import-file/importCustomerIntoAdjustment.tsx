...
const exampleCustomerFile =
  "https://yody-prd-media.s3.ap-southeast-1.amazonaws.com/files/loyalty-import/PointAdjustmentExample.xlsx";
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div style={{ marginLeft: 15 }}>
              <strong style={{ fontSize: 16 }}>
                Bạn có chắc chắn muốn hủy điều chỉnh điểm cho các khách hàng theo file tải lên
                không?
              </strong>
            </div>
          </div>
