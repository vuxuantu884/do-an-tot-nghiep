...
const WebAppOrders: React.FC = () => {
    ...
    const handleFilter = (value: any) => {
        ...
        if (newParams.cancelled_on_max != null) {
            newParams.cancelled_on_max = moment(newParams.cancelled_on_max, "DD-MM-YYYY").format("DD-MM-YYYY");
        }
    ...
    const [columns] = useState<Array<ICustomTableColumType<OrderModel>>>([
        ...
        },
        {
            ...
            render: (status_value: string) => {
                ...
                return (
                    <StyledStatus>
                        <div className={OrderStatus.getClassName(status_value)}>{OrderStatus.getName(status_value)}</div>
                    </StyledStatus>
                );
            },
        },
