...
const ProgressDownloadProductsModal = (props: ProgressDownloadProductsModalType) => {
  const { visible, isLoading, onOk, onCancel, progressData, progressPercent, processType } = props;
  ...
  return (
    <Modal
      ...
      centered
      visible={visible}
      title={ProcessTypeContants.getTitle(processType)}
      okText="Xác nhận"
      cancelText="Hủy"
