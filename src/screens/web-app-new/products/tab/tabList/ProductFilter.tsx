  ...
  return (
    <StyledProductFilter>
      <div className="filter">
        <Form ref={form} onFinish={handleFinish} initialValues={params}>
        ...
        <div className="order-filter-tags">
          {filterTags &&
            filterTags.map((filter: any, index: any) => {
              return (
                <Tag
                  key={index}
                  className="tag"
                  closable
                  onClose={(e) => handleRemoveTag(e, filter)}
                >
      ...
      >
        <StyledBaseFilter>
          <Form ref={form} onFinish={handleFinish} initialValues={params} layout="vertical">
            {type !== "connected" && (
