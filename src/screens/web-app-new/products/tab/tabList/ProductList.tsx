...
const ProductList = (props: ProductListprops) => {
    const { type, exportFileProduct, syncSingleStock, syncMultiStock, getVariantData, isReloadData } = props;
    ...
    }, [type, selectedRows, variantData, allowProductsUpdateStock, allowProductsDelete, allowProductsDisconnect])
