...
const ProgressConnectByExcelModal: React.FC<ProgressConnectByExcelModalProps> = (
    props: ProgressConnectByExcelModalProps
) => {
...
export default ProgressConnectByExcelModal;