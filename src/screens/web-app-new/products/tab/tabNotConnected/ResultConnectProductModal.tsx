  ...
  const [columns] = useState<any>([
    ...
    },
    {
      ...
      render: (item: any, row: any, index: any) => {
        return (
          <div>
            Sản phẩm <strong>{item}</strong> ghép nối không thành công
          </div>
        );
      },
    },
        ...
        <div>
          ...
          <span>
            ...
            <p style={{ color: "green", display: "inline-block" }}>
              {connectProductData?.success_total}
            </p>{" "}
            sản phẩm ghép nối thành công
          </span>
        </div>
        ...
        <div style={{ marginBottom: 10 }}>
          ...
          <span>
            ...
            <p style={{ color: "red", display: "inline-block" }}>
              {connectProductData?.error_total}
            </p>{" "}
            sản phẩm ghép nối thất bại
          </span>
        </div>
