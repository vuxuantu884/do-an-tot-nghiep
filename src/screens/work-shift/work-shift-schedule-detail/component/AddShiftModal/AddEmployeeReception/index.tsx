...
import { EnumShiftAssigner, WeeksShiftModel } from "screens/work-shift/work-shift-helper";
    ...
    <StyledComponent>
      <Row className="employee-reception-header">
        <p className="employee-reception-header-text">
          Chọn thời gian sắp xếp cho nhân viên tiếp đón
        </p>
      ...
      {shiftSelection === EnumShiftAssigner.manual && (
