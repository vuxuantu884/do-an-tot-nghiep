...
import CardReturnMoney from "./CardReturnMoney";
import CardReturnOrder from "./CardReturnOrder";
import CardReturnProducts from "./CardReturnProducts";
import CardReturnReceiveProducts from "./CardReturnReceiveProducts";
...
const ScreenReturnDetail = (props: PropType) => {
  ...
  const [listOrders, setListOrders] = useState<OrderLineItemResponse[]>([]);
