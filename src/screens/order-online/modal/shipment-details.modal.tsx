    ...
    <Modal
      ...
      title={[
        <span style={{ fontWeight: 600, fontSize: 16 }}>
          Chi tiết đơn giao hàng {shipmentDetails.code}
        </span>,
      ]}
      width={700}
      footer={[
        ...
        {shipmentDetails.shipping_address && (
          ...
          >
            <div style={{ width: "30%", borderRight: "1px solid #E5E5E5" }}>
              <p style={{ color: "#2A2A86", marginBottom: "5px" }}>
                {shipmentDetails.shipping_address.name}
              </p>
            ...
            <div style={{ width: "70%", paddingLeft: "3%" }}>
              ...
              <p style={{ color: "#666666", marginBottom: 0 }}>
                {shipmentDetails.shipping_address.full_address}
              </p>
            </div>
          </div>
        )}
        ...
        <div style={{ width: "50%" }}>
            ...
            <div style={{ color: "#2A2A86" }}>
              <NumberFormat
                value={formatCurrency(
                  shipmentDetails.total_discount ? shipmentDetails.total_discount : 0,
                )}
                className="foo"
                displayType={"text"}
              />
          ...
          >
            ...
            <div style={{ color: "#2A2A86" }}>
              <NumberFormat
                value={formatCurrency(
                  shipmentDetails?.order?.shipping_fee_informed_to_customer || 0,
                )}
                className="foo"
                displayType={"text"}
              />
          ...
          >
            ...
            <div style={{ color: "#2A2A86" }}>
              <NumberFormat
                value={formatCurrency(
                  shipmentDetails?.shipment?.cod ? shipmentDetails.shipment.cod : 0,
                )}
                className="foo"
                displayType={"text"}
              />
