...
import { getHandoverService, updateHandoverService, deleteOrderHandoverService } from "service/handover/handover.service";
...
const CreateHandoverScreeen: React.FC<any> = (props: any) => {
  ...
  const onFinish = useCallback((orders: Array<HandoverOrderRequest>, fulfillments: Array<FulfillmentDto>) => {
  ...
  return (
    ...
    >
      {
        handoverData.isLoad && fulfilmentData.isLoad && (
          <Form
            layout="vertical"
            ...
            initialValues={{
              ...
              order_display: fulfilmentData.data,
            }}
          >
            <StyledComponent>
              <Card>
              ...
              <FulfillmentComponent
                ...
                onDelete={(codes, onSuccess: () => void) => {
                  ...
                  deleteOrderHandoverService(handoverId, codes)
                    .then((response) => {
                      if (isFetchApiSuccessful(response)) {
                        let orders: Array<HandoverOrderRequest> = goodsReceiptsForm.getFieldValue("orders");
                        let order_display: Array<FulfillmentDto> = goodsReceiptsForm.getFieldValue("order_display");
                        codes.forEach((code) => {
                          let indexOrders = orders.findIndex((value) => value.fulfillment_code === code);
