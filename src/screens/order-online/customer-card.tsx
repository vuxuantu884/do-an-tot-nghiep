        ...
        (value, o) => {
            ...
            index = resultSearch.findIndex(
                (customerResponse: CustomerResponse) =>
                    customerResponse.id &&
                    customerResponse.id.toString() === value
            );
            if (index !== -1) {
                ...
                if (
                    ...
                    resultSearch[index].shipping_addresses.forEach(
                        (item, index2) => {
                ...
                if (
                    ...
                    resultSearch[index].billing_addresses.forEach(
                        (item, index2) => {
                            if (item.default === true) {
                                        ...
                                        >
                                            ...
                                            <Row>
                                                <Popover
                                                    ...
                                                    trigger="click"
                                                    onVisibleChange={
                                                        handleVisibleBillingAddressChange
                                                    }
                                                    className="change-shipping-address"
                                                >
                                                    <Button
