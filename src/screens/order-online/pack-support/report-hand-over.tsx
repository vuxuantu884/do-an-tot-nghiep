...
const ReportHandOver: React.FC = () => {
  ...
  const handSubmit = useCallback((value:any) => {
    ...
    let ecommerce_name=listSourcesEcommerce.find((data)=>data.id===value.ecommerce_id)?.name;
    ...
    console.log("Goods",param)
    // dispatch(createGoodsReceipts(param, (value:any)=>{
    //   console.log("Goods",value)
    // }));
  },[ data,listGoodsReceipts,listSourcesEcommerce,listStores,listThirdPartyLogistics])
