...
import {
  getBankAction,
  getIdBankAccountAction,
  putBankAccountAction,
} from "domain/actions/bank/bank.action";
...
const BackAccountUpdateScreen: React.FC = () => {
  ...
  useEffect(() => {
    if (BankAccountId) {
      dispatch(
        getIdBankAccountAction(BankAccountId, (data: BankAccountResponse) => {
          if (data) {
            setInitialValues({
              id: data.id,
              code: data.code,
  ...
  const onSubmitForm = useCallback(
    (value) => {
      ...
      dispatch(
        putBankAccountAction(BankAccountId, request, (data: BankAccountResponse) => {
