...
const StoreExportModal: React.FC<ExportModalProps> = (props: ExportModalProps) => {
  ...
  return (
    <Modal
      ...
      cancelText="Hủy"
      onOk={onOkClick}
      title="Xuất file danh sách cửa hàng"
      okText="Xuất file"
    >
      <Form
        form={form}
              ...
              <Form.Item name="record">
                <Radio.Group>
                  <Space direction="vertical">
                    <Radio value={TYPE_EXPORT.page}>Cửa hàng trên trang này</Radio>
                    <Radio value={TYPE_EXPORT.selected}>Các cửa hàng được chọn</Radio>
                    <Radio value={TYPE_EXPORT.all}>Tất cả cửa hàng đủ điều kiện lọc</Radio>
                    <Radio value={TYPE_EXPORT.allin}>Tất cả cửa hàng</Radio>
                  </Space>
                </Radio.Group>
              </Form.Item>
            </Fragment>
...
export default StoreExportModal;
