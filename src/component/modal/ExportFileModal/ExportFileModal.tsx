...
const ExportFileModal: React.FC<ExportModalProps> = (props: ExportModalProps) => {
  const { visible, onCancel, onOk, results, exportProgress, status, textOK, isExportList, title } =
    props;
    ...
    >
      {status === ExportFileStatus.Export && (
        <div>
          ...
          <Radio.Group
            name="radiogroup"
            defaultValue={ExportFileType.INPAGE}
            onChange={(e) => setExportTye(e.target.value)}
          >
