// @ts-ignore
import {Button, Card, Divider, Checkbox, Input,  Row, Col, AutoComplete, Space, Typography,  Popover} from "antd";
...
const CustomerCard: React.FC<CustomerCardProps> = (props: CustomerCardProps) => {
  ...
  return (
    <Card className="card-block card-block-customer"
          title={<div className="d-flex"><img src={peopleIcon2} alt="" /> Khách hàng</div>}
          extra={
      ...
      <Row align="middle" justify="space-between" className="row-customer-detail">
        ...
        <Space className="customer-detail-action">
          ...
          ><img src={editBlueIcon} alt=""/></Button>
        ...
        <Row gutter={24}>
          <Col xs={24} lg={12} className="font-weight-500 customer-info-left">
            ...
            <Row className="row-info customer-row-info">
              <img src={peopleIcon2} alt="" style={{ width: 19 }} /> <span style={{ marginLeft: 9 }}>Na</span>
            </Row>
            <Row className="row-info customer-row-info">
                         ...
                         <div className="change-shipping-address-content">
                           <div className="shipping-address-row">
                             <div className="shipping-address-name">
                               Địa chỉ 1 <Button type="text"
                                                 onClick={showAddressModal}
                                                 className="p-0"><img src={editBlueIcon} alt=""/></Button>
                             </div>
