...
import { FulFillmentResponse, TrackingLogFulfillmentResponse } from "model/response/order/order.response";
...
const DeliveryProgress: React.FC<Props> = (props: Props) => {
    ...
    const [trackingLog, setTrackingLog] = useState<Array<TrackingLogFulfillmentResponse> | null>(null);
    ...
    const getCheckingLogFulfillment = useCallback((_fulfillments: FulFillmentResponse[] | FulFillmentResponse) => {
    ...
    const renderOrderTrackingLog = (_fulfillments: FulFillmentResponse[] | FulFillmentResponse, _isShowTrackingLog: boolean, _trackingLog: Array<TrackingLogFulfillmentResponse> | null) => {
