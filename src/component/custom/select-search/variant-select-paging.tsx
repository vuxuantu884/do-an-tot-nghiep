...
function SelectSearch(contentProps: SelectContentProps) {
  ...
  const [data, setData] = React.useState<PageResponse<VariantSku3Response>>({
    items: [],
    metadata: {
      page: 1,
      limit: 30,
...
const VariantSku3SearchPaging = React.memo(SelectSearch, () => {
  return false;
});

export default VariantSku3SearchPaging;
