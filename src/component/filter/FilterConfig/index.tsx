  ...
  return (
    <span className="" style={{ marginRight: 20, display: "inline-flex" }}>
      <Tag
        ...
        style={{
          cursor: "pointer",
          backgroundColor: props.tagAcitve === props.index ? primaryColor : "",
          color: props.tagAcitve === props.index ? "white" : "",
        }}
        key={props.index}
        icon={<StarOutlined />}
        closeIcon={
          <CloseOutlined
            className={
              props.tagAcitve === props.index ? "ant-tag-close-icon" : "ant-tag-close-icon-black"
            }
          />
        }
        closable={true}
