  ...
  return (
    <StyledComponent>
      ...
      >
        <Row gutter={20}>
          <Col span={24}>
            <Form.Item name="name" label={<b>Tên người liên hệ:</b>} rules={[]}>
              <Input
            ...
            <Form.Item name="phone" label={<b>Số điện thoại:</b>} rules={[]}>
              <Input
            ...
            <Form.Item name="full_address" label={<b>Địa chỉ chi tiết:</b>} rules={[]}>
              <Input
            ...
            >
              <Checkbox style={{paddingBottom: 8, marginLeft: 20}} onChange={handleChangeDefault}></Checkbox>
            </Form.Item>
          </Col>
        </Row>
      </Form>
