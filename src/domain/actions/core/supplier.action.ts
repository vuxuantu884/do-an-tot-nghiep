...
export const SupplierUpdateAction = (id: number, request: SupplierUpdateRequest, setData: (response: SupplierResponse) => void) => {
  return BaseAction(SupplierType.EDIT_SUPPLIER_REQUEST, {id, request, setData});
}

export const SupplierDetailAction = (id: number, setData: (response: SupplierResponse) => void) => {
