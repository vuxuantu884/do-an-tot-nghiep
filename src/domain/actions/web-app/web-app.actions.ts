...
export const webAppConfigDeleteAction = (id: number, setData: (result: boolean) => void) => {
...
export const webAppConnectAction = (ecommerceId: number, setData: (result: any) => void) => {
...
export const webAppConfigInfoAction = (params: any, setData: (result: WebAppResponse) => void) => {
...
export const getWebAppProductAction = (query: WebAppProductQuery, setData: (data: any) => void) => {
  return BaseAction(WebAppType.WEB_APP_GET_VARIANTS_REQUEST, {
    query,
    setData,
  });
};
...
export const downloadWebAppProductAction = (
  ...
  return BaseAction(WebAppType.WEB_APP_DOWNLOAD_PRODUCT_REQUEST, {
    query,
    setData,
  });
};
...
export const deleteWebAppProductAction = (ids: any, setData: (data: any) => void) => {
  return BaseAction(WebAppType.WEB_APP_DELETE_PRODUCT_REQUEST, {
    ids,
    setData,
  });
};
...
export const disconnectWebAppProductAction = (ids: any, setData: (data: any) => void) => {
  return BaseAction(WebAppType.WEB_APP_DISCONNECT_PRODUCT_REQUEST, {
    ids,
    setData,
  });
};
...
export const syncWebAppOrderAction = (query: any, setData: (data: any) => void) => {
...
export const putConnectWebAppProductAction = (query: any, setData: (data: any) => void) => {
  return BaseAction(WebAppType.WEB_APP_PUT_CONNECT_PRODUCT_REQUEST, {
    query,
    setData,
  });
};
...
export const downloadWebAppOrderAction = (
  ...
  return BaseAction(WebAppType.WEB_APP_DOWNLOAD_ORDER_REQUEST, {
    query,
    setData,
  });
};
...
export const webAppConcatenateByExcelAction = (
  formData: FormData,
  callback: (data: any) => void,
) => {
  return BaseAction(WebAppType.WEB_APP_CONCANATE_BY_EXCEL, {
    formData,
    callback,
  });
};

export const downloadWebAppPrintForm = (request: any, callback: (data: any) => void) => {
