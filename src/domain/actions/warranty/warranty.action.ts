...
export const getDetailsWarrantyAction = (id: string, setData: (data: any) => void) => {
  return BaseAction(WarrantyType.GET_DETAILS_WARRANTY_REQUEST, { id, setData });
};

export const createWarrantyAction = (body: any, setData: (data: any) => void) => {
  return BaseAction(WarrantyType.CREATE_WARRANTY_REQUEST, { body, setData });
};

export const updateWarrantyAction = (id: string, body: any, setData: (data: any) => void) => {
  return BaseAction(WarrantyType.UPDATE_WARRANTY_REQUEST, {
    id,
    body,
    setData,
  });
...
export const getWarrantyReasonsAction = (setData: (data: Array<any>) => void) => {
