...
import { DepartmentFilterProps, DepartmentRequest, DepartmentResponse } from "model/account/department.model";
...
const searchDepartmentPagingAction = (query: DepartmentFilterProps, onResult: (result: PageResponse<DepartmentResponse> | false) => void) => {
  return BaseAction(DepartmentType.SEARCH_DEPARTMENT_PAGING, { query, onResult });
};
...
export {searchDepartmentAction, departmentDetailAction, departmentCreateAction, departmentUpdateAction, searchDepartmentPagingAction};
