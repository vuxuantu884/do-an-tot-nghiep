...
const createLoyaltyRate = (addingRate: number, usageRate: number, setData: (data: LoyaltyRateResponse) => void) => {
  return BaseAction(LoyaltyRateType.CREATE_LOYALTY_RATE_REQUEST, { addingRate, usageRate, setData });
}
