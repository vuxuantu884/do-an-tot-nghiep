...
function* listDataOrderProcessingStatusSaga(action: YodyAction) {
  ...
  try {
    let response: BaseResponse<PageResponse<OrderProcessingStatusResponseModel>> = yield call(
      getOrderProcessingStatusService,
      queryParams,
    );
...
export function* settingOrderProcessingStatusSaga() {
  yield takeLatest(SETTING_TYPES.orderProcessingStatus.listData, listDataOrderProcessingStatusSaga);
  yield takeLatest(SETTING_TYPES.orderProcessingStatus.create, addOrderProcessingStatusSaga);
  yield takeLatest(SETTING_TYPES.orderProcessingStatus.edit, editOrderProcessingStatusSaga);
  yield takeLatest(SETTING_TYPES.orderProcessingStatus.delete, deleteOrderProcessingStatusSaga);
}
